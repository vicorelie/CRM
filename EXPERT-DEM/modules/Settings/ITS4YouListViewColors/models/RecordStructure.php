...
class Settings_ITS4YouListViewColors_RecordStructure_Model extends Vtiger_RecordStructure_Model
{
    ...
    {
        $className = Vtiger_Loader::getComponentClassName('Model', $mode . 'RecordStructure', 'Settings:ITS4YouListViewColors');
