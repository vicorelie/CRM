    ...
    <div id="VtEmailTaskContainer" style="padding-bottom: 100px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        <input type="hidden" id="template" name="template" value={Zend_Json::encode($TASK_OBJECT->getTemplateIds())}>
                        <select multiple id="template_select" data-rule-required="true" name="template_select" class="select2 task-fields" style="width: 100%;">
                            {html_options  options=$TASK_OBJECT->getTemplates($SOURCE_MODULE) selected=$TASK_OBJECT->getTemplateIds()}
                        </select>
                    </div>
                </div>
                <div class="row form-group">
