...
{strip}
    ...
    <div class="middle-block col-lg-8">
        {if $ATTACHMENTS}
            <div class="summaryWidgetContainer">
                <div class="widgetContainer_attachments"  data-url="module=ITS4YouEmails&view=AttachmentsWidget&record={$RECORD_ID}" data-name="showAttachments">
                    <div class="widget_header">
                        <h4 class="display-inline-block">{vtranslate('LBL_ATTACHMENTS',$MODULE_NAME)}</h4>
                    </div>
                    <div class="widget_contents">
        ...
        <div class="summaryWidgetContainer">
            <div class="widgetContainer_body" data-url="module=ITS4YouEmails&view=BodyWidget&record={$RECORD_ID}" data-name="showBody">
                <div class="widget_header">
                    <h4 class="display-inline-block">{vtranslate('LBL_MESSAGE',$QUALIFIED_MODULE)}</h4>
                </div>
                <div class="widget_contents">
