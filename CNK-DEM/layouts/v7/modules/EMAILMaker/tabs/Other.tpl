    ...
    <div class="tab-pane" id="pdfContentOther">
        <div class="edit-template-content col-lg-4" style="position:fixed;z-index:1000;">
            ...
            <div class="form-group" id="listview_block_tpl_row">
                ...
                {************************************ Signature variables *******************************************}
                {if !empty($SIGNATURE_VARIABLES)}
                    <div class="form-group">
                        <label class="control-label fieldLabel col-sm-3" style="font-weight: normal">
                            {vtranslate('SIGNATURE_VARIABLES',$MODULE)}:
                        </label>
                        <div class="controls col-sm-9">
                            <div class="input-group">
                                <select name="customfunction" id="signature_variables" class="select2 form-control">
                                    {html_options options=$SIGNATURE_VARIABLES}
                                </select>
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-success InsertIntoTemplate" data-type="signature_variables" title="{vtranslate('LBL_INSERT_TO_TEXT',$MODULE)}">
                                        <i class="fa fa-usd"></i>
                                    </button>
                                </div>
                            </div>
