	...
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
				...
				{elseif $smarty.request.view eq 'List'}
					<p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="{vtranslate('LBL_LISTS', $MODULE)}">&nbsp;&nbsp;{vtranslate('LBL_LISTS', $MODULE)} &nbsp;&nbsp;</a></p>
				{elseif $smarty.request.view eq 'EditKeyMetricsRow'}
					<p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span>
						<a title="{vtranslate($KM_NAME, $MODULE)}" href="index.php?module={$MODULE}&view=KeyMetricsRows&id={$KM_ID}">&nbsp;&nbsp;{vtranslate($KM_NAME, $MODULE)} &nbsp;&nbsp;</a>
					</p>
				{else}
					<p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="{vtranslate($KM_NAME, $MODULE)}">&nbsp;&nbsp;{vtranslate($KM_NAME, $MODULE)} &nbsp;&nbsp;</a></p>
				{/if}
			</div>
			<div class="col-lg-5 col-md-5 pull-right">
				<div id="appnav" class="navbar-right">
					{if 'KeyMetricsRows' neq $smarty.request.view}
