{*<!--
/*+***********************************************************************************
* Template personnalisé pour les actions de masse des Leads
* Ajoute le bouton "Transférer vers AMYAS" dans le menu Plus
************************************************************************************/
-->*}
                ...
                {if php7_count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
                    <div class="btn-group listViewMassActions" role="group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            {* NOUVEAU : Bouton de transfert vers AMYAS *}
                            <li class="hide">
                                <a id="{$MODULE}_listView_massAction_TRANSFER_TO_AMYAS" href="javascript:void(0);" onclick="transferToAMYAS()">
                                    <i class="fa fa-share" style="margin-right: 5px;"></i>Transférer vers AMYAS
                                </a>
                            </li>
                            {if php7_count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
