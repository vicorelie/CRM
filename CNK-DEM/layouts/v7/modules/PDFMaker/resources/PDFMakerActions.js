...
jQuery.Class("PDFMaker_Actions_Js",{
    ...
    getModuleName() {
        ...
        return 'Events' === moduleName ? 'Calendar' : moduleName;
    },
    getRelatedController : function(forRelatedModuleName) {
        let self = this,
            recordId = app.getRecordId(),
            moduleName = PDFMaker_Actions_Js.getModuleName(),
            selectedTabElement = self.getSelectedTab(),
            relatedModuleName = self.getRelatedModuleName(),
            relatedListClass = 'Vtiger_RelatedList_Js';
    ...
    savePDFToDoc: function (templateIds, language) {
        ...
        params['return_module'] = PDFMaker_Actions_Js.getModuleName();
    ...
    getDefaultParams: function (viewType, templateIds, language) {
        let self = this,
            ...
            params = {
                module: 'PDFMaker',
                source_module: PDFMaker_Actions_Js.getModuleName(),
                formodule: PDFMaker_Actions_Js.getModuleName(),
                forview: forView,
            };
    ...
    sendEmailPDF: function (templateIds, templateLanguage) {
        let self = this,
            params = {
                ...
                to: '',
                source_module: '',
                sourceModule: PDFMaker_Actions_Js.getModuleName(),
                sourceRecord: '',
                parentModule: PDFMaker_Actions_Js.getModuleName(),
                ispdfactive: '1',
    ...
    registerEvents: function (){
        let self = this,
            ...
            detailViewButtonContainerDiv = jQuery('.detailview-header');
