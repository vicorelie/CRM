    ...
    <div class="row">
        <div class="col-md-3">
            <div class="btn-group listViewMassActions" role="group">
                    {if PDFMaker_Utils_Helper::count($LISTVIEW_MASSACTIONS)}
                            ...
                            <ul class="dropdown-menu">
                                    {if PDFMaker_Utils_Helper::count($LISTVIEW_MASSACTIONS) gt 0}
                                        ...
                                        {if PDFMaker_Utils_Helper::count($LISTVIEW_LINKS['LISTVIEW'])}<li class="divider"></li> {/if}
                                    {/if}
                                    
                                    {if PDFMaker_Utils_Helper::count($LISTVIEW_LINKS['LISTVIEW'])}
