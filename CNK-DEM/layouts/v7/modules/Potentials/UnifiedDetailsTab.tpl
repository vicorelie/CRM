...
<div class="details-tab-container" id="detailsTabContainer" data-record-id="{$RECORD->getId()}" data-module="{$MODULE_NAME}" data-contact-id="{$RECORD->get('contact_id')}">
                                ...
                                <div class="form-group">
                                    ...
                                    {if $IS_EDITABLE}
                                        <select class="unified-field-input" name="{$FIELD_NAME}" data-fieldname="{$FIELD_NAME}" data-fieldtype="{$fieldDataType}">
                                            <option value="">--</option>
                                            {foreach item=PICKLIST_VALUE from=$FIELD_MODEL->getEditablePicklistValues()}
    ...
    <div class="card accordion-card suppl-address-accordion" style="padding: 0; overflow: hidden;">
        ...
        <div class="accordion-content" style="display: none;">
            {if $SUPPL_CHARGEMENT_FIELDS neq null}{assign var=SC value=$SUPPL_CHARGEMENT_FIELDS}{/if}
            {if $SUPPL_LIVRAISON_FIELDS neq null}{assign var=SL value=$SUPPL_LIVRAISON_FIELDS}{/if}

            {* === ROW 1: Chargement 2 (left) + Livraison 2 (right) === *}
            <div style="display: flex; gap: 15px; padding: 15px;">
                {* -- Chargement 2 -- *}
                <div style="flex: 1;" data-block="{$SUPPL_CHARGEMENT_KEY}">
                    ...
                    <div class="form-fields-grid form-fields-address" style="padding: 12px 15px; background: #f8f9fa; border-radius: 0 0 8px 8px;">
                        ...
                        {if isset($SC.cf_1367)}<div class="form-group"><label>Demande stationnement</label><select class="unified-field-input" name="cf_1367" data-fieldname="cf_1367" data-fieldtype="picklist"><option value="">--</option>{foreach item=PV from=$SC.cf_1367->getEditablePicklistValues()}<option value="{$PV}" {if $SC.cf_1367->get('fieldvalue') eq $PV}selected{/if}>{$PV}</option>{/foreach}</select></div>{/if}
                ...
                {* -- Livraison 2 -- *}
                <div style="flex: 1;" data-block="{$SUPPL_LIVRAISON_KEY}">
                    ...
                    <div class="form-fields-grid form-fields-address" style="padding: 12px 15px; background: #f8f9fa; border-radius: 0 0 8px 8px;">
                        ...
                        {if isset($SL.cf_1385)}<div class="form-group"><label>Demande stationnement</label><select class="unified-field-input" name="cf_1385" data-fieldname="cf_1385" data-fieldtype="picklist"><option value="">--</option>{foreach item=PV from=$SL.cf_1385->getEditablePicklistValues()}<option value="{$PV}" {if $SL.cf_1385->get('fieldvalue') eq $PV}selected{/if}>{$PV}</option>{/foreach}</select></div>{/if}
            ...
            {* === ROW 2: Chargement 3 (left) + Livraison 3 (right) === *}
            <div style="display: flex; gap: 15px; padding: 0 15px 15px;">
                ...
                <div style="flex: 1;" data-block="{$SUPPL_CHARGEMENT_KEY}">
                    ...
                    <div class="form-fields-grid form-fields-address" style="padding: 12px 15px; background: #f8f9fa; border-radius: 0 0 8px 8px;">
                        ...
                        {if isset($SC.cf_1376)}<div class="form-group"><label>Demande stationnement</label><select class="unified-field-input" name="cf_1376" data-fieldname="cf_1376" data-fieldtype="picklist"><option value="">--</option>{foreach item=PV from=$SC.cf_1376->getEditablePicklistValues()}<option value="{$PV}" {if $SC.cf_1376->get('fieldvalue') eq $PV}selected{/if}>{$PV}</option>{/foreach}</select></div>{/if}
                ...
                <div style="flex: 1;" data-block="{$SUPPL_LIVRAISON_KEY}">
                    ...
                    <div class="form-fields-grid form-fields-address" style="padding: 12px 15px; background: #f8f9fa; border-radius: 0 0 8px 8px;">
                        ...
                        {if isset($SL.cf_1394)}<div class="form-group"><label>Demande stationnement</label><select class="unified-field-input" name="cf_1394" data-fieldname="cf_1394" data-fieldtype="picklist"><option value="">--</option>{foreach item=PV from=$SL.cf_1394->getEditablePicklistValues()}<option value="{$PV}" {if $SL.cf_1394->get('fieldvalue') eq $PV}selected{/if}>{$PV}</option>{/foreach}</select></div>{/if}
