...
<div class="inventaire-tab-container" id="inventaireTabContainer"
    ...
    {* Categories Container - Populated by JS *}
    <div id="unified-categories-container">
    ...
    <div class="inventory-save-bar">
        <button class="btn btn-purple btn-lg" onclick="UnifiedInventaire.save()">
