...
class Settings_ITS4YouInstaller_Extensions_View extends Settings_Vtiger_Index_View
{
    ...
    public function preProcess(Vtiger_Request $request, $display = true)
    {
        ...
        $viewer->assign('FIELDS_INFO', null);
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        $viewer = $this->getViewer($request);
        $viewer->assign('ERROR_MESSAGES', null);
        $viewer->assign('USER_NAME', null);
        $viewer->assign('CUSTOMER_PROFILE', null);
	    ...
	    $modelInstance->updateExtensionsAlerts();
    }
