...
if (!defined('QRCODEDEFS')) {
	...
	// Encoding modes (characters which can be encoded in PHPQRCode_QRCode)
	...
	/**
	 * Encoding mode numeric (0-9). 3 characters are encoded to 10bit length. In theory, 7089 characters or less can be stored in a PHPQRCode_QRCode.
	 */
	define('QR_MODE_NM', 0);

	/**
	 * Encoding mode alphanumeric (0-9A-Z $%*+-./:) 45characters. 2 characters are encoded to 11bit length. In theory, 4296 characters or less can be stored in a PHPQRCode_QRCode.
	 */
	define('QR_MODE_AN', 1);

	/**
	 * Encoding mode 8bit byte data. In theory, 2953 characters or less can be stored in a PHPQRCode_QRCode.
	 */
	define('QR_MODE_8B', 2);

	/**
	 * Encoding mode KANJI. A KANJI character (multibyte character) is encoded to 13bit length. In theory, 1817 characters or less can be stored in a PHPQRCode_QRCode.
	 */
	define('QR_MODE_KJ', 3);
	...
	// PHPQRCode_QRCode has a function of an error correcting for miss reading that white is black.
	...
	// Version. Size of PHPQRCode_QRCode is defined as version.
...
if (!class_exists('PHPQRCode_QRCode', false)) {
	...
	class PHPQRCode_QRCode {
		...
		/**
		 * @var QR code version. Size of PHPQRCode_QRCode is defined as version. Version is from 1 to 40. Version 1 is 21*21 matrix. And 4 modules increases whenever 1 version increases. So version 40 is 177*177 matrix.
		 * @access protected
		 */
		protected $version = 0;
		 ...
		 * Creates a PHPQRCode_QRCode object
		 * @param string $code code to represent using PHPQRCode_QRCode
	...
	} // end PHPQRCode_QRCode class

} // END OF "class_exists PHPQRCode_QRCode"
?>
