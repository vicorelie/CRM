<?php
/* Smarty version 4.5.5, created on 2026-02-01 23:49:37
  from '/var/www/CNK-DEM/layouts/v7/modules/Potentials/UnifiedDevisTab.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_697fca71dd0a31_83517935',
...
function content_697fca71dd0a31_83517935 (Smarty_Internal_Template $_smarty_tpl) {
...
)" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['QUOTE']->value['subject'], ENT_QUOTES, 'UTF-8', true);?>
"><div class="chip-line1"><span class="chip-no"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['QUOTE']->value['quote_no'], ENT_QUOTES, 'UTF-8', true);?>
</span><span class="chip-sep">/</span><span class="chip-date"><?php echo $_smarty_tpl->tpl_vars['QUOTE']->value['created_date'];?>
</span></div><div class="chip-line2"><span class="chip-formule"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->tpl_vars['QUOTE']->value['cf_1125'] ?? null)===null||$tmp==='' ? '-' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
...
" data-name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['TEMPLATE']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" style="display:none;"><span class="pdf-template-name"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['TEMPLATE']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</span></div><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><div style="margin-top: 12px; display: flex; gap: 10px; align-items: center;"><input type="email" id="unified_pdfRecipientEmail" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['CONTACT_EMAIL']->value, ENT_QUOTES, 'UTF-8', true);?>
