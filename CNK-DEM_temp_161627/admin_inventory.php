...
<body>
            ...
            <form method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group" id="new-category-label-field" style="display: none;">
                        ...
                        <input type="text" id="new-category-label-input" placeholder="ex: Garage, Salle de bain, Cave">
                    </div>
                </div>
    ...
    <script>
        // Fonction pour générer l'ID de catégorie à partir du nom
        function generateCategoryId(name) {
            return name
                .toLowerCase()
                .normalize('NFD').replace(/[\u0300-\u036f]/g, '') // Enlever les accents
                .replace(/[^a-z0-9]+/g, '_') // Remplacer les caractères spéciaux par underscore
        ...
        function updateCategoryInfo() {
            ...
            if (select.value === 'new') {
                // Afficher le champ pour nouvelle catégorie
                ...
                // Cacher le champ pour nouvelle catégorie
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (addForm && addForm.querySelector('input[name="action"][value="add"]')) {
                addForm.addEventListener('submit', function(e) {
                    ...
                    if (select.value === 'new') {
                        // Si nouvelle catégorie, récupérer le nom et générer l'ID automatiquement
                        ...
                        if (!newCategoryLabel) {
                            e.preventDefault();
                            alert('❌ Veuillez remplir le nom de la nouvelle catégorie');
                            return false;
                        }

                        // Générer l'ID automatiquement à partir du nom
                        const newCategoryId = generateCategoryId(newCategoryLabel);
