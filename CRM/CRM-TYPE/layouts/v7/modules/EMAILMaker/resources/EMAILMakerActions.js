...
jQuery.Class("EMAILMaker_Actions_Js", {
    ...
    emailmaker_sendMail: function (pdftemplateid, pdflanguage, pid, forCampaigns) {
        let self = this,
            source_module = EMAILMaker_Actions_Js.getModuleName(),
            ...
            if (data === true) {
                ...
                if (forCampaigns) {
                    let selectedTabElement = self.getSelectedTab(),
                        ...
                        relatedController = new Campaigns_RelatedList_Js(app.getRecordId(), EMAILMaker_Actions_Js.getModuleName(), selectedTabElement, relatedModuleName),
    ...
    addRelatedButtons: function () {
        ...
        if (EMAILMaker_Actions_Js.getModuleName() === "Campaigns") {
