<?php
/* Smarty version 4.5.5, created on 2025-10-20 09:00:53
  from '/home3/vicorelie/crm.tcerenov-design.com/layouts/v7/modules/Users/Login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68f5fa45c00dd7_80848230',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e4664fdc41a580c2afb554fc23474069bd5f0492' => 
    array (
      0 => '/home3/vicorelie/crm.tcerenov-design.com/layouts/v7/modules/Users/Login.tpl',
      1 => 1753978890,
      2 => 'file',
    ),
  ),
...
</span></div><div id="loginFormDiv"><form class="form-horizontal" method="POST" action="index.php"><input type="hidden" name="module" value="Users"/><input type="hidden" name="action" value="Login"/><div class="group"><input id="username" type="text" name="username" placeholder="Utilisateur"><span class="bar"></span><label>Utilisateur</label></div><div class="group"><input id="password" type="password" name="password" placeholder="Mot de passe"><span class="bar"></span><label>Mot de passe</label></div><?php $_smarty_tpl->_assignInScope('CUSTOM_SKINS', Vtiger_Theme::getAllSkins());
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><?php }?><div class="group"><button type="submit" class="button buttonBlue">Entrer</button><br><a class="forgotPasswordLink" style="color: #15c;">Mot de passe oublié ?</a></div></form></div><div id="forgotPasswordDiv" class="hide"><form class="form-horizontal" action="forgotPassword.php" method="POST"><div class="group"><input id="fusername" type="text" name="username" placeholder="Utilisateur" ><span class="bar"></span><label>Utilisateur</label></div><div class="group"><input id="email" type="email" name="emailId" placeholder="Email" ><span class="bar"></span><label>Email</label></div><div class="group"><button type="submit" class="button buttonBlue forgot-submit-btn">soumettre</button><br><span>Veuillez saisir les détails et soumettre<a class="forgotPasswordLink pull-right" style="color: #15c;">Retour</a></span></div></form></div></div></div><div class="col-lg-1 hidden-xs hidden-sm hidden-md"></div><?php echo '<script'; ?>
>
