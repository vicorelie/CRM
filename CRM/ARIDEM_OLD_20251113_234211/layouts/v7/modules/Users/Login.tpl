...
{strip}
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-19-4 col-1g-offset-4">
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<input id="username" type="text" name="username" placeholder="Utilisateur">
							<span class="bar"></span>
						...
						{/if}
					<div class="group">
							<button type="submit" class="button buttonBlue">Entrer</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						<div class="group">
							<input id="fusername" type="text" name="username" placeholder="Utilisateur" >
							<span class="bar"></span>
							<label>Utilisateur</label>
						</div>
						<div class="group">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">soumettre</button><br>
							<span>Veuillez saisir les détails et soumettre<a class="forgotPasswordLink pull-right" style="color: #15c;">Retour</a></span>
						</div>
					</form>
				</div>
			</div>
