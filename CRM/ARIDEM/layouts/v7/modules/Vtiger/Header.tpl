...
<html>
	<head>
        ...
        {* Améliorations subtiles - ARIDEM *}
        <link type='text/css' rel='stylesheet' href='layouts/v7/resources/subtle-enhancements.css?v={time()}'>
		...
		{* Modern Theme JavaScript - ARIDEM - DISABLED *}
