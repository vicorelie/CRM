...
// Increased to 1024M for PDF merging with 5+ documents
...
$HELPDESK_SUPPORT_EMAIL_ID = 'contact@crm-aridem.webama.fr';
$HELPDESK_SUPPORT_NAME = 'ARIDEM';
...
$dbconfig['db_username'] = 'vicorelie_vtig844';
$dbconfig['db_password'] = 'r!55SyOp5(';
$dbconfig['db_name'] = 'vicorelie_vtig844';
...
$site_URL = 'https://crm-aridem.webama.fr/';

// url for customer portal (Example: http://vtiger.com/portal)
$PORTAL_URL = rtrim($site_URL,'/').'/customerportal';
// root directory path
$root_directory = '/var/www/CRM/ARIDEM/';
...
$application_unique_key = 'expdsuiannaiqklorea3s3llbkbeonnt';
