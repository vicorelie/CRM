...
$stmt = $conn->prepare("SELECT
    p.potentialname,
    pcf.cf_volume_inventaire,
    pcf.cf_cartons_estimes,
    pcf.cf_inventaire_json
...
$savedVolume = $data['cf_volume_inventaire'] ?? 0;
$savedBoxes = $data['cf_cartons_estimes'] ?? 0;
$savedInventory = $data['cf_inventaire_json'] ?? '{}';
...
<body>
    ...
    <script>
        ...
        const SAVED_VOLUME = <?php echo $savedVolume; ?>;
        const SAVED_BOXES = <?php echo $savedBoxes; ?>;
