<?php
/* Smarty version 4.5.5, created on 2025-12-07 15:54:32
  from '/var/www/CRM/ARIDEM/layouts/v7/modules/Users/Login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6935a338e74f90_54248328',
...
function content_6935a338e74f90_54248328 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</span></div><div id="loginFormDiv"><form class="form-horizontal" method="POST" action="index.php"><input type="hidden" name="module" value="Users"/><input type="hidden" name="action" value="Login"/><div class="group"><input id="username" type="text" name="username"><span class="bar"></span><label>Utilisateur</label></div><div class="group"><input id="password" type="password" name="password"><span class="bar"></span><label>Mot de passe</label></div><?php $_smarty_tpl->_assignInScope('CUSTOM_SKINS', Vtiger_Theme::getAllSkins());
