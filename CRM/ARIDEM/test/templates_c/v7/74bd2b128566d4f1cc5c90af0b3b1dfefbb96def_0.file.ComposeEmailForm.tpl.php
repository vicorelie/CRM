<?php
/* Smarty version 4.5.5, created on 2025-11-21 09:32:50
  from '/var/www/CRM/ARIDEM/layouts/v7/modules/Vtiger/ComposeEmailForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_692031c26b6cf1_23962797',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '74bd2b128566d4f1cc5c90af0b3b1dfefbb96def' => 
    array (
      0 => '/var/www/CRM/ARIDEM/layouts/v7/modules/Vtiger/ComposeEmailForm.tpl',
      1 => 1763717514,
      2 => 'file',
    ),
  ),
...
function content_692031c26b6cf1_23962797 (Smarty_Internal_Template $_smarty_tpl) {
...
</p></div></div><div class="row templateContent"><div class="col-lg-12"><div class="col-lg-2"><span class=""><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></div><div class="col-lg-10"><textarea style="width:100%;height:300px;" id="description" name="description"><?php if (!empty($_smarty_tpl->tpl_vars['DESCRIPTION']->value)) {
echo $_smarty_tpl->tpl_vars['DESCRIPTION']->value;
}?></textarea></div></div></div><?php if ((isset($_smarty_tpl->tpl_vars['RELATED_LOAD']->value)) && $_smarty_tpl->tpl_vars['RELATED_LOAD']->value == true) {?><input type="hidden" name="related_load" value=<?php echo $_smarty_tpl->tpl_vars['RELATED_LOAD']->value;?>
