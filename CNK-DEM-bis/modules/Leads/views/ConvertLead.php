...
class Leads_ConvertLead_View extends Vtiger_Index_View {
	...
	/**
	 * Vérifier si l'email est confirmé avant de permettre la conversion
	 */
	public function checkPermission(Vtiger_Request $request) {
		...
		if ($recordId) {
			...
			// Si l'email de confirmation ne correspond pas à l'email principal, bloquer la conversion
			if (empty($emailConfirmation) || $emailConfirmation !== $emailPrincipal) {
				throw new AppException(vtranslate('LBL_EMAIL_NOT_CONFIRMED_CONVERT', 'Leads'));
			}
		}
	}
